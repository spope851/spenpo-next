  ...
  return (
    <td className="projects-table-data">
      <ul className="app-description">
        ...
        <ul>
          <li>
            click each square and use the color picker to set the colors to match
            your cube
          </li>
          <li>
            each time a color is changed validation is performed to ensure the cube
            can be solved
          </li>
          <ul>
            <li>
        ...
        <li>
          <a
            href="https://github.com/spope851/cube"
            target="_blank"
            rel="noreferrer"
          >
            github
