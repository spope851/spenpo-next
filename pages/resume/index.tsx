      ...
      <Accordion>
        ...
        <AccordionDetails>
          ...
          <Typography>
            ...
            React.js, Next.js, Node.js, Svelte.js, PostgreSQL, SQL Server, MongoDB,
            .Net, Docker, AWS
          </Typography>
        </AccordionDetails>
      </Accordion>
          ...
          <Accordion>
            ...
            <AccordionDetails>
              <List>
                ...
                <ListItem>
                  <Typography>
                    Studied Information Systems & Business Analytics with the Peter
                    T. Paul School of Business and Economics
                  </Typography>
                </ListItem>
                <ListItem sx={{ ml: 5 }}>
                  <Typography>
          ...
          <Accordion>
            ...
            <AccordionDetails>
              <List>
                <ListItem>
                  <Typography>
                    Studied Mandarin 20 hours per week with the College of Intensive
