...
export type GetBlogPostsQuery = { __typename?: 'Query', allPosts: { __typename?: 'Posts', posts: Array<{ __typename?: 'BlogPost', ID: string, content: string, title: string, date: string, excerpt: string, tags: Array<{ __typename?: 'Tag', name: string, ID: string, slug: string, post_count?: number | null }> }> } };
...
export type GetBlogPostsWithTagQuery = { __typename?: 'Query', allPosts: { __typename?: 'Posts', posts: Array<{ __typename?: 'BlogPost', ID: string, content: string, title: string, date: string, excerpt: string, tags: Array<{ __typename?: 'Tag', name: string, ID: string, slug: string, post_count?: number | null }> }> } };
